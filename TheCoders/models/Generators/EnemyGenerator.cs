...
namespace TheCoders.models.Generators
{
    ...
    {
        private static readonly string[] possibleNames = { "Bartholomew", "Dewy", "Travis Scott", "Kevin Lamar", "Katy Perry", "Jeffery Dalmer", "Donald Trump", "Donald Of Trump", "Freddie Mercury", "Orel", "Sid", "Sid The Sloth", "Turbo The Snail", "Lady Gaga", "Talor Swift", "Sony The Company", "Data Center", "Geofery Bezos", "Helen Keller", "Hellen Degenerate", "Person with glasses", "Imposter", "Sam Altmen", "Adam Sandler", "Tom Cruise", "Mr. Krebs", "Herobrine From Minecraft", "Mr. Krabs", "The Shortest Person", "The Person The Internet Votes For", "Error 404 Name Not Found", "Izak Fernandez", "Izak Fernandez", "Izak Fernandez", "Izak Fernandez", "Izak Fernandez", "Izak Fernandez", "Izak Fernandez", "Izak Fernandez", "Izak Fernandez", "Izak Fernandez", "Weapon Enchant", "Ranged Weapon", "I lost the game", "Elin Tusk", "Schnee Dust Company", "Wiliam A. Afton", "The Knower", "Rat King", "John Adam", "John Lennon", "Verne Troyer", "Michael Jackson", "Justin Bieber", "Cocomelon", "Franklin", "Coraline", "Darkness", "Handsome Jack", "Claptrap", "Captain Flynt", "Gargamel", "Dr. Zomboss", "Garfield",  };
